...
/**
 * Used as a response to the `getLatestBlock` method in the `BlockExplorer`
 * class.
 */
public class LatestBlock extends SimpleBlock {
	...
	public LatestBlock(JsonObject b) {
		this(b.get("height").getAsLong(), b.get("hash").getAsString(), b.get("time").getAsLong(), true,
				b.get("block_index").getAsLong(), null);
