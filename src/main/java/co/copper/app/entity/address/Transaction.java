...
public class Transaction {
	...
	public String toString() {
		return "Transaction [doubleSpend=" + doubleSpend + ", blockHeight=" + blockHeight + ", time=" + time
				+ ", lockTime=" + lockTime + ", relayedBy=" + relayedBy + ", hash=" + hash + ", index=" + index
				+ ", version=" + version + ", size=" + size + ", inputs=" + inputs + ", outputs=" + outputs + "]";
	}
	...
	public Transaction(boolean doubleSpend, long blockHeight, long time, long lockTime, String relayedBy, String hash,
			long index, int version, long size, List<Input> inputs, List<Output> outputs) {
