package co.copper.app.entity.wallet;
...
public class PaymentResponse {
	...
	public boolean equals(Object o) {
		...
		if (o instanceof PaymentResponse) {
			...
			return (this.getMessage().equals(that.getMessage()) && this.getTxHash().equals(that.getTxHash())
					&& this.getNotice().equals(that.getNotice()));
		}
		return false;
	}
